#coded by agx
import sys, cls, webbrowser, platform, subprocess
...
def menu():
	__limpiar()
     ...
     print """                                          K   K                 OOOOOOOOOOOOOOOOOO        NNNNNN        N                    GGGGGGGGGGG      
     W        W        W        U           U           K  K                  O                O        N     N       N                   G
      W      W W      W         U           U           KK                    O                O        N      N      N                   G            
       W    W   W    W          U           U           KK                    O                O        N        N    N                   GGGGGGGGGGGGGGGG
        W  W     W  W           U           U           K K                   O                O        N          N  N                   G              G
         WW       WW             UUUUUUUUUU             K  K                   OOOOOOOOOOOOOOOO         N           NN                    GGGGGGGGGGGGGGGG
print '''
